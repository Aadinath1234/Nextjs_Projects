...
import { Description, Dialog, Disclosure, Popover, Transition } from "@headlessui/react";
            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global" >
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-12">
                    <Popover className="relative">
                        ...
                        >
                         <Popover.Panel className="absolute bg-white -left-8 top-full z-10 mt-3 w-screen max-w-nd  overflow-hidden 
                         rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                            <div className="p-4">
                                {products.map((item) => (
                                   ...
                                   p-4 text-sm  leading-6 hover:bg-gray-50                                   
                                   ">
